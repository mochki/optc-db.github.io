	...
	angular.module("optc").run(function ($rootScope, $timeout, $storage) {
		...
		var tableFilter = function (settings, data, index) {
			...
			if (
				filters.globalKC &&
				[
					4348, 4349, 2601, 4344, 4336, 4337, 4338, 4339, 4340, 4342, 4343, 
					4345, 4346, 4347, 4350, 2940, 2944, 2938, 2942, 2936, 2946, 2948, 
					2950, 2952, 3300, 3204, 3349, 3391, 3508, 3590, 3884, 3780, 3824, 
					3886, 3917, 3967, 4008, 4054, 4098, 4115, 4118, 4137, 4167, 4182, 
					4197, 4216, 4257, 4253, 4267, 4268, 4290, 4275, 4285, 4287, 4291, 
					4292, 4293, 4294, 4303, 4319, 4322, 4323, 4329, 4332, 4333, 4334, 
					4335, 4341
				].indexOf(id) == -1
			)
				return false;
