	...
	angular.module("optc").run(function ($rootScope, $timeout, $storage) {
		...
		var tableFilter = function (settings, data, index) {
			...
			if (
				filters.globalTM &&
				[
					4300, 4301, 4302, 4297, 4280, 4290, 4291, 4292, 4293, 4298, 4285, 
					4287, 4288, 4289, 4294, 4295, 4296, 4299, 4261, 3364, 3462, 3483, 
					3523, 3543, 3563, 3641, 3735, 3775, 3861, 3933, 4003, 4050, 4071, 
					4133, 4179, 4193, 4227, 4250, 4274, 4282, 1916, 2158, 2261, 2940, 
					2944, 2938, 2942, 2936, 2946, 2948, 2950, 2952, 2893, 2908, 3263, 
					3416, 3884, 3758, 3822, 3886, 3931, 3776, 3777, 4180, 4181, 4267, 
					4268, 4269, 4270, 4283, 4284, 
				].indexOf(id) == -1
			)
				return false;
			if (
