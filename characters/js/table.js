	...
	angular.module("optc").run(function ($rootScope, $timeout, $storage) {
		...
		var tableFilter = function (settings, data, index) {
			...
			if (
				filters.globalKC &&
				[
					4319, 4320, 5061, 4307, 4308, 4309, 4310, 4312, 4313, 4317, 4318, 
					4314, 4315, 4316, 4321, 2940, 2944, 2938, 2942, 2936, 2946, 2948, 
					2950, 2952, 3300, 3204, 3349, 3391, 3508, 3590, 3884, 3780, 3824, 
					3886, 3917, 3967, 4008, 4010, 4037, 4054, 4115, 4137, 4167, 4182, 
					4211, 4197, 4212, 4216, 4219, 4231, 4257, 4253, 4267, 4268, 4290, 
					4275, 4276, 4285, 4287, 4291, 4292, 4293, 4294, 4305, 4303, 4304, 
					4306, 4311
				].indexOf(id) == -1
			)
				return false;
