	...
	angular.module("optc").run(function ($rootScope, $timeout, $storage) {
		...
		var tableFilter = function (settings, data, index) {
			...
			if (
				filters.globalTM &&
				[
					4314, 4315, 4316, 4311, 4298, 4307, 4308, 4312, 4290, 4291, 4292, 
					4293, 4295, 4296, 4303, 4306, 4309, 4310, 4313, 4280, 4317, 3364, 
					3462, 3483, 3523, 3543, 3563, 3641, 3735, 3775, 3861, 3933, 4003, 
					4050, 4071, 4133, 4179, 4193, 4227, 4250, 4274, 4282, 4300, 1667, 
					2064, 2473, 2394, 2729, 2792, 2940, 2944, 2938, 2942, 2936, 2946, 
					2948, 2950, 2952, 2846, 2995, 3551, 3884, 3886, 3981, 4275, 4276, 
					4277, 4278, 3642, 3643, 4194, 4195, 4283, 4284, 4301, 4302
				].indexOf(id) == -1
			)
				return false;
			if (
